...
const Activity = () => {
  ...
  const ModalAjout = (item) => {
    setAjoutModal(true);
  };
  const ModalAjoutAnnuler = (item) => {
    setAjoutModal(false);
  };
  ...
  const renderItem = ({ item }) => (
    ...
    >
      <View
        style={tw`bg-gray-600 p-4 shadow-md rounded-md mb-4 flex-row ml-4 mr-4 items-center justify-center`}
      >
